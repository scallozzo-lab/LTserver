...
DROP TABLE IF EXISTS devcalendar CASCADE;
...
CREATE TABLE devices (
    ...
    devconfig int NOT NULL,devcalendar
        -- Configuración del dispositivo (bitcode)
...
-- =========================================================
-- TABLE: devcalendar
-- Configured calentar for each device.
-- =========================================================
CREATE TABLE devcalendar
(
